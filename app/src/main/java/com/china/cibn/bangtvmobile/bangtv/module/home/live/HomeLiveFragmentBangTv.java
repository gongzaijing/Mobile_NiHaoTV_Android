package com.china.cibn.bangtvmobile.bangtv.module.home.live;
...
* BangTv分类页面
* */
public class HomeLiveFragmentBangTv extends RxLazyFragment {
...
public static String menuId;
  ...
  public static HomeLiveFragmentBangTv newInstance(String id) {
    menuId = id;

    return new HomeLiveFragmentBangTv();
  }
  ...
  * */
  ...
  protected void finishTask() {
    ...
    mSectionedRecyclerViewAdapter.setLiveInfo(recomendBannersList,mList,false,"live");
