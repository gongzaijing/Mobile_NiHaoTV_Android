...
public class ConstantUtil {
  ...
  public static final String EXTRA_BANGTV_MOVIELIST_RID = "extra_bangtv_movielist_rid";

  public static final String EXTRA_BANGTV_MOVIELIST_NAME = "extra_bangtv_movielist_name";
